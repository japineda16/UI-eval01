<template>
    ...
    <body>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                            Corporis amet sequi molestiae tenetur eum mollitia, blanditiis, magnam illo
                                            magni error dolore unde perspiciatis tempore et totam corrupti dignissimos
                                            aut praesentium?
                                        </p>
                                        <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
                                    </div>
        ...
        <component is="script" src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></component>
        <component is="script" src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js">
        </component is="script">
        <component is="script" src="../lib/wow/wow.min.js"></component is="script">
        <component is="script" src="../lib/easing/easing.min.js"></component is="script">
        <component is="script" src="../lib/waypoints/waypoints.min.js"></component is="script">
        <component is="script" src="../lib/counterup/counterup.min.js"></component is="script">
        <component is="script" src="../lib/lightbox/js/lightbox.min.js"></component is="script">
        <component is="script" src="../lib/owlcarousel/owl.carousel.min.js"></component is="script">


        <!-- Template Javascript -->
        <component is="script" src="../js/main.js"></component is="script">
    </body>
</template>
